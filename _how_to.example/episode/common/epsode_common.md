# epsode_common（恋愛・親愛・一般エピソード技法・索引・抜粋版）

以下のテキストはエピソードに深みを持たせるためのテンプレートです。

本雛形（`_how_to.example`）は **抜粋版** です。恋愛・親愛・描写の厚みの正本は、次の3ファイルへ分割しました（2026-07-03）。**本文の欠落は意図していません。** 旧来の1ファイル参照は、この索引から該当カテゴリーを開いてください。
...
関連: [../general/episode_.md](../general/episode_.md)（一般型・職業）
